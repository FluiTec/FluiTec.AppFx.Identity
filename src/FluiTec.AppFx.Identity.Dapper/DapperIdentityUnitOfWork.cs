...
namespace FluiTec.AppFx.Identity.Dapper
{
    ...
    public class DapperIdentityUnitOfWork : DapperUnitOfWork, IIdentityUnitOfWork
    {
        ...
        public DapperIdentityUnitOfWork(IDapperDataService dataService, ILogger<IUnitOfWork> logger) : base(dataService,
            logger)
        {
        ...
        /// <param name="dataService">      The data service. </param>
        /// <param name="logger">           The logger. </param>
        public DapperIdentityUnitOfWork(DapperUnitOfWork parentUnitOfWork, IDataService dataService,
